...
use OAuthBundle\WeiXin\Pay\Request\WxPayReport;
use OAuthBundle\WeiXin\Pay\Request\WxPayResults;
use WeixinBundle\Services\Pay\Exception\WxPayException;
...
class WxPay 
{
     ...
     * @return 成功时返回，其他抛异常
     */
    public static function unifiedOrder($inputObj, $timeOut = 6, $isApp=false)
    {
        ...
        $WxPayResults->setPaysignkey(WxPayConfig::KEY);
...
//        dump($result);die();
    ...
    private static function postXmlCurl($xml, $url, $useCert = false, $second = 30)
    {
        ...
        if($data){
            ...
            $error = curl_errno($ch);
            curl_close($ch);
            throw new WxPayException("通讯错误码:$error");
        }
    }
