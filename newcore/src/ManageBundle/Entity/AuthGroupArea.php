 ...
 * AuthGroupArea
 *
 * @ORM\Table(name="auth_group_area")
 * @ORM\Entity
 */
class AuthGroupArea
{
     ...
     * @var integer
     *
     * @ORM\Column(name="rulesarea", type="integer", length=100, nullable=false)
     */
    private $rulesarea;
     ...
     * Set rulesarea
     *
     * @param integer $rulesarea
     * @return AuthGroupArea
     */
    public function setRulesarea($rulesarea)
    {
