 ...
 * Views
 *
 * @ORM\Table(name="views", indexes={@ORM\Index(name="name", columns={"name"}), @ORM\Index(name="bundle", columns={"bundle"}), @ORM\Index(name="controller", columns={"controller"})})
 * @ORM\Entity
 */
class Views
{
     ...
     * @var string
     *
     * @ORM\Column(name="useform", type="string", length=100, nullable=false)
     */
    private $useform;
     ...
     * @var integer
     *
     * @ORM\Column(name="cache", type="smallint", length=2, nullable=false)
     */
    private $cache;
