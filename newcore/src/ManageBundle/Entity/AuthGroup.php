 ...
 * AuthGroup
 *
 * @ORM\Table(name="auth_group", indexes={@ORM\Index(name="uid", columns={"uid"}), @ORM\Index(name="region", columns={"region"})})
 * @ORM\Entity
 */
class AuthGroup
{
     ...
     * @var integer
     *
     * @ORM\Column(name="mgroup", type="smallint", length=2, nullable=false)
     */
    private $mgroup;
     ...
     * @var string
     *
     * @ORM\Column(name="inherit", type="string", length=100, nullable=false)
     */
    private $inherit;
