 ...
 * PushsAttr
 *
 * @ORM\Table(name="pushs_attr", indexes={@ORM\Index(name="name", columns={"name"}), @ORM\Index(name="mid", columns={"mid"})})
 * @ORM\Entity
 */
class PushsAttr
{
     ...
     * @var integer
     *
     * @ORM\Column(name="puid", type="integer", length=10, nullable=false)
     */
    private $puid;
