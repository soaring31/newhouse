 ...
 */
namespace OAuthBundle\Security\Http\Firewall;
...
class OAuthListener extends AbstractAuthenticationListener
{
    ...
    protected function attemptAuthentication(Request $request)
    {
        ...
        if ($request->query->has('authenticated') && $resourceOwner->getOption('auth_with_one_url')) {
            ...
            return new RedirectResponse(sprintf('%s?code=%s&authenticated=true', $this->httpUtils->generateUri($request, 'oauth_connect_service'), $request->query->get('code')));
        }
