...
class WeiXinJSPay extends WeiXinPay
{
    /**
     * 
    ...
    public function getJsApiParameters($UnifiedOrderResult)
    {
        ...
        $jsapi["nonce_str"] = $this->getNonceStr();
        $jsapi["package"] = "prepay_id=" . $UnifiedOrderResult['prepay_id'];
        $jsapi["signType"] = "MD5";
        $jsapi["paySign"] = $this->MakeSign($this->config['paysignkey']);
    ...
    public function getOpenidFromMp($code)
    {
        ...
        $res = $this->resourceOwner->httpRequest($url, $xml);
    ...
    private function __createOauthUrlForOpenid($code)
    {
        $urlObj = array();
        $urlObj["appid"] = $this->config['appid'];
        $urlObj["secret"] = $this->config['mchid'];
        $urlObj["code"] = $code;
