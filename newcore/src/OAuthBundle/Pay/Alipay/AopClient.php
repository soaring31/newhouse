...
* @author 08cms项目开发团队
* @package 08cms
* create date 2017年3月1日
*/
namespace OAuthBundle\Pay\Alipay;

use CoreBundle\Services\ServiceBase;
use Symfony\Component\DependencyInjection\ContainerInterface;

class AopClient  extends ServiceBase 
{
    //应用ID
    public $appId;
    ...
    public function getConfig()
    {
        return array(
            ...
            'private_key' => file_get_contents ( getcwd().'\\alipaycert\privatekey.pem' ),
    
            //支付宝的公钥，查看地址：https://b.alipay.com/order/pidAndKey.htm
            'alipay_public_key' => trim($this->get('core.common')->C('alipay_key')),
    
            //服务器异步通知页面路径需http://格式的完整路径，不能加?id=123这类自定义参数，必须外网可以正常访问
            'notify_url' => 'http://leunico.yicp.io/newcore/web/app_dev.php/OAuth/return/alinotify',
            //'notify_url' => $this->get('core.common')->U('/','',TRUE).'/OAuth/return/alinotify',
    
            //页面跳转同步通知页面路径,需http://格式的完整路径，不能加?id=123这类自定义参数，必须外网可以正常访问
            'return_url' => 'http://leunico.yicp.io/newcore/web/app_dev.php/OAuth/return/alireturn',
    ...
    public function generateSign(array $params, $signType = "RSA") {
        return $this->sign($this->getSignContent($params), $signType);
    }
    
    public function rsaSign(array $params, $signType = "RSA") {
        return $this->sign($this->getSignContent($params), $signType);
    }
    ...
    public function exec($paramsArray) {
        ...
        $inflector = array();//new \LtInflector();
