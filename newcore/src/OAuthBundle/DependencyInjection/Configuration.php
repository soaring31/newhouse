    ...
    public function getConfigTreeBuilder()
    {
        ...
        $rootNode
            ->children()
                ...
                ->scalarNode('failed_auth_path')->defaultValue('oauth_connect')->end()
                ->scalarNode('default_target_path')->defaultValue('oauth_login')->end()
                ->scalarNode('register_target_path')->defaultValue('oauth_login')->end()
            ->end()
        ;
                    ...
                    ->prototype('array')
                        ...
                        ->validate()
                            ->ifTrue(function($c) {
                                ...
                                foreach (array('oauthid', 'nickname', 'realname') as $child) {
                            ...
                            ->thenInvalid("At least the 'oauthid', 'nickname' and 'realname' paths should be configured for 'oauth2' and 'oauth1' types.")
                        ->end()
                        ->validate()
                            ->ifTrue(function($c) {
                                if (isset($c['service'])) {
