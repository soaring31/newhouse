 ...
 */
    ...
    class QRspec {
        ...
        public static function getDataLength($version, $level)
        {
            ...
            return $capacity[$version][QRCAP_WORDS] - $capacity[$version][QRCAP_EC][$level];
        }
        ...
        {
            $capacity = self::$capacity;
            return $capacity[$version][QRCAP_EC][$level];
        }
        ...
        {
            $capacity = self::$capacity;
            return $capacity[$version][QRCAP_WIDTH];
        }
        ...
        {
            $capacity = self::$capacity;
            return $capacity[$version][QRCAP_REMINDER];
        }
        ...
        public static function getMinimumVersion($size, $level)
        {
            ...
            {
                $words  = $capacity[$i][QRCAP_WORDS] - self::$capacity[$i][QRCAP_EC][$level];
                if($words >= $size) 
                    return $i;
            }
        ...
        public static function lengthIndicator($mode, $version)
        {
            ...
            $lengthTableBits = self::$lengthTableBits;
        ...
        {
            $capacity = self::$capacity;
            $width = $capacity[$version][QRCAP_WIDTH];
