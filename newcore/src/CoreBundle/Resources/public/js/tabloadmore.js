 ...
 * @example 调用
 * ```html
 * <a  data-more-init="1" data-role="ajax" data-pre-page-index="1" data-page-index="1" data-config="{cate_id: ''}" href="news/list">最新</a>
 * 
 * ```
 * ```js
 *tabLoadmore.init({
...
//# sourceMappingURL=tabloadmore.js.map
