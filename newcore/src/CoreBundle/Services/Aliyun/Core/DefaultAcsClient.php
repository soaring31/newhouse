...
use CoreBundle\Services\Aliyun\Core\Http\HttpHelper;
use CoreBundle\Services\Aliyun\Core\Regions\EndpointProvider;
use CoreBundle\Services\Aliyun\Core\Exception\ClientException;
use CoreBundle\Services\Aliyun\Core\Exception\ServerException;
