...
class GeetestLib  extends ServiceBase
{
    /**
     *  Geetest配置文件
     * @author Tanxu
     */
    const  CAPTCHA_ID = "2ca2e42dd6633ed546cde604756d6ee8";
    const  PRIVATE_KEY = "ab021eff97b9f0d7632ee1e4847ea681";
    const  MOBILE_CAPTCHA_ID = "7c25da6fe21944cfe507d2f9876775a9";
    const  MOBILE_PRIVATE_KEY = "f5883f4ee3bd4fa8caec67941de1b903";
    ...
    public function __construct(ContainerInterface $container) 
    {
        ...
        {
            $this->captcha_id  = self::MOBILE_CAPTCHA_ID;
            $this->private_key = self::MOBILE_PRIVATE_KEY;
        }else 
        {
