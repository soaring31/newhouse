...
class FragmentstplType extends BaseType
{
    protected $container;
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        ...
        $clonePath .= "Template".DIRECTORY_SEPARATOR."Fragments";
        ...
        if (is_dir($clonePath))
        {
            ...
            {
                $relativePath = "Fragments".DIRECTORY_SEPARATOR.$file->getRelativePath();
