...
class CocurSlugifyExtension extends Extension
{
    ...
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        $slugifyArguments = array_intersect_key($config, array_flip(array('lowercase', 'regexp', 'rulesets')));

        $container->setDefinition('cocur_slugify', new Definition('Cocur\Slugify\Slugify', array($slugifyArguments)));
        $container
            ->setDefinition(
