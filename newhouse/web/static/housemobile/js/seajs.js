...
var seajsCfg = {
    ...
    'cookie'        : 'housemobile/js/static/jq.cookie',
    ...
    'webcookie'      : 'housemobile/js/static/webcookie',
    // 封装函数文件
    'commonFn'       : 'housemobile/js/commonFn',
    // ajax请求封装
    'zgrequest'      : 'housemobile/js/zgrequest',
    };
    ...
    seajs.config({
        ...
        preload: ['jquery'],  // 预加载项
        charset: 'UTF-8',        // 文件编码
        // 前端JS统一全局变量 js调用规则实例：seajs.data.vars.externalLinks
        vars:{
            // 外部引用api域名
            'externalLinks':'http://api.zhugefang.com/API/',
            // 新房系统api域名测试
            // 'apiUrl':'http://cms.zhuge.com/api/v1',
            // 新房系统api域名线上
            'apiUrl':'http://newhouse.zhuge.com/api/v1'
        }
    });


//# sourceMappingURL=http://localhost:8888/public/js/seajs.js.map
