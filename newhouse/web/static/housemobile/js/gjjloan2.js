 ...
 * @author <%= author %>
 * @date <%= date %>
 * @description:related fund loans
 */
...
exports.gjjloan2 = function(obj) 
{
    ...
    obj.need.value = dked;
    if (dked == 0) {
        _alert('需要的贷款额度不能为空,请输入');
        obj.need.value = '';
        return;
    }
    if (dked < 0) {
        _alert('输入的贷款额度不符合要求,请输入');
        obj.need.value = '';
        return;
    }
...
//# sourceMappingURL=http://localhost:8888/public/js/gjjloan2.js.map
