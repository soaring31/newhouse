...
var newValue = llData.value.slice(0,4);

llData.title = newTitle.concat(llData.title);

llData.value = newValue.concat(llData.value);


function getDates(date){
  return (''+date.getFullYear()).slice(2)+'年'+(date.getMonth()+1)+'月'+date.getDate()+'日';
};
...
//# sourceMappingURL=http://localhost:8888/public/js/rate.js.map
