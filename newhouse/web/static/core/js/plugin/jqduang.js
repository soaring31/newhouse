...
!function ($, win, undefined) {
     ...
     * @param {boolean} o.autoplay=1 自动播放
     * @param {number} o.interval=3000 播放间隔时间
     ...
     * @param {string} o.titletpl 当前播放的标题的模板 可以是这样：`'<a class="tit-jd" target="_blank" href="%url%">%title%</a>'` 其中的 `%url% %title%` 会被替换成对应的内容
     * @param {string} o.pagewrap jq选择器 要显示分页内容的父级
     * @param {boolean} o.wheel=0 是否启用鼠标滚动播放
    ...
    Duang.prototype = {
        ...
        init: function() {
            ...
            if (!!o.showtit && o.visible == 1) {
                ...
                // 兼容v2.01之前的代码
                _self.$title = $(o.titletpl.replace(/%url%/g, objD.url).replace(/%title%/g, objD.title)).insertAfter($objPP)
...
//# sourceMappingURL=http://localhost:8888/public/js/plugin/jqduang.js.map
