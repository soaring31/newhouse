...
define('utils', [], function (require, exports, module) {
    ...
    var utils = {
         ...
         * ```
         */
        searchParams: function searchParams(name) {
            var _this = this;
        ...
        localStorage: {
            ...
            setItem: function setItem(name, val, time) {
                window.localStorage && localStorage.setItem(name, val + '||' + (new Date().getTime() + time * (1000 * 60 * 60 * 24)));
            },
            /**
             * @method getItem
             * @description 获取值
...
//# sourceMappingURL=http://localhost:8888/public/js/mobile-utils.js.map
