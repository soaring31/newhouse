 ...
 * Houses
 *
 * @ORM\Table(name="houses", indexes={@ORM\Index(name="cate_type", columns={"cate_type"}), @ORM\Index(name="area", columns={"area"}), @ORM\Index(name="dj", columns={"dj"}), @ORM\Index(name="kpdate", columns={"kpdate"}), @ORM\Index(name="top", columns={"top"}), @ORM\Index(name="type", columns={"type"}), @ORM\Index(name="checked", columns={"checked"}), @ORM\Index(name="uid", columns={"uid"}), @ORM\Index(name="cate_metro", columns={"cate_metro"}), @ORM\Index(name="cate_line", columns={"cate_line"}), @ORM\Index(name="cate_circle", columns={"cate_circle"}), @ORM\Index(name="region", columns={"region"}), @ORM\Index(name="complex_id", columns={"complex_id"}), @ORM\Index(name="hot_line", columns={"hot_line"}), @ORM\Index(name="web_tel", columns={"web_tel"}), @ORM\Index(name="pc_tel", columns={"pc_tel"}), @ORM\Index(name="app_tel", columns={"app_tel"}), @ORM\Index(name="tdj", columns={"tdj"})})
 * @ORM\Entity
 */
class Houses
{
     ...
     * @var integer
     *
     * @ORM\Column(name="complex_id", type="integer", length=11, nullable=false)
     */
    private $complex_id;
     ...
     * @var string
     *
     * @ORM\Column(name="alias_name", type="string", length=100, nullable=false)
     */
    private $alias_name;
     ...
     * @var string
     *
     * @ORM\Column(name="hot_line", type="string", length=1024, nullable=false)
     */
    private $hot_line;
     ...
     * @var string
     *
     * @ORM\Column(name="web_tel", type="string", length=32, nullable=false)
     */
    private $web_tel;
     ...
     * @var string
     *
     * @ORM\Column(name="pc_tel", type="string", length=32, nullable=false)
     */
    private $pc_tel;
     ...
     * @var string
     *
     * @ORM\Column(name="app_tel", type="string", length=32, nullable=false)
     */
    private $app_tel;
     ...
     * @var float
     *
     * @ORM\Column(name="tdj", type="float", length=100, nullable=false)
     */
    private $tdj;
     ...
     * @return Houses
     */
    public function setWebTel($webTel)
    {
        $this->web_tel = $webTel;
     ...
     * @return Houses
     */
    public function setPcTel($pcTel)
    {
        $this->pc_tel = $pcTel;
     ...
     * @return Houses
     */
    public function setAppTel($appTel)
    {
        $this->app_tel = $appTel;
