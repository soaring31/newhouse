 ...
 * EntrustArc
 *
 * @ORM\Table(name="entrust_arc", indexes={@ORM\Index(name="aid", columns={"aid"}), @ORM\Index(name="mid", columns={"mid"})})
 * @ORM\Entity
 */
class EntrustArc
{
     ...
     * @var string
     *
     * @ORM\Column(name="mid", type="string", length=100, nullable=false)
     */
    private $mid;
