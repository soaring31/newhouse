...
class Wages
{
     ...
     * @var \DateTime
     *
     * @ORM\Column(name="time", type="date", length=10, nullable=false)
     */
    private $time;
     ...
     * @var integer
     *
     * @ORM\Column(name="pay_status", type="smallint", length=100, nullable=false)
     */
    private $pay_status;
     ...
     * @var string
     *
     * @ORM\Column(name="member_account", type="string", length=100, nullable=false)
     */
