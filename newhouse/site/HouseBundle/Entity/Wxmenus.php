...
class Wxmenus
{
     ...
     * @var string
     *
     * @ORM\Column(name="kno", type="string", length=2, nullable=false)
     */
    private $kno;
     ...
     * @var string
     *
     * @ORM\Column(name="title", type="string", length=24, nullable=false)
     */
    private $title;
     ...
     * @var string
     *
     * @ORM\Column(name="type", type="string", length=48, nullable=false)
     */
    private $type = 'click';
