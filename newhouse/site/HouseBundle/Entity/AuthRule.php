...
class AuthRule
{
     ...
     * @var integer
     *
     * @ORM\Column(name="pmenuid", type="integer", length=10, nullable=false)
     */
    private $pmenuid;
     ...
     * @var string
     *
     * @ORM\Column(name="identities", type="string", length=100, nullable=false)
     */
    private $identities;
     ...
     * @return AuthRule
     */
    public function setPmenuid($pmenuid)
    {
