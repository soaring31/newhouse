...
class Msglog
{
     ...
     * @var string
     *
     * @ORM\Column(name="uip", type="string", length=100, nullable=false)
     */
    private $uip;
     ...
     * @var string
     *
     * @ORM\Column(name="cc", type="string", length=100, nullable=false)
     */
    private $cc;
     ...
     * @var string
     *
     * @ORM\Column(name="mm", type="string", length=100, nullable=false)
     */
    private $mm;
