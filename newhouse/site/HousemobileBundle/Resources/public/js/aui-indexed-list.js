...
(function(window, document, undefined){
    var _init = function(){
        ...
        var indexedWrap = document.querySelector(".aui-indexed-list-wrap");
        // 搜索类
        var searchWrap = document.querySelector(".bar-header-secondary");
        ...
        var newBarH = barList.length*14 + 3;
        var con = $('.content');
        // document.querySelector('h1').innerHTML = searchWrap.offsetHeight;
            ...
            setTimeout(function(){
                ...
                if (groupElement) {
                    ...
                    // indexedWrap.scrollTop = groupElement.offsetTop;
                     con.scrollTop(groupElement.offsetTop)
                }
            },100)
        },false)
...
//# sourceMappingURL=..\..\..\..\site\HousemobileBundle\Resources\src\js\aui-indexed-list.js.map
