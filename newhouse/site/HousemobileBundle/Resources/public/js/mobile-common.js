...
define(['ajax', 'utils'], function (require, exports, module) {
    ...
    var app = {
        ...
        validate: function validate($form) {
            ...
            $form.find(['select', 'textarea', '[type="text"]', '[type="password"]', '[type="file"]', '[type="number"]', '[type="search"]', '[type="tel"]', '[type="url"]', '[type="email"]', '[type="datetime"]', '[type="date"]', '[type="month"]', '[type="week"]', '[type="time"]', '[type="datetime-local"]', '[type="range"]', '[type="color"]', '[type="radio"]', '[type="checkbox"]'].join(',')).each(function (index, el) {
